            ...
            <ListGroup variant="flush">
              {this.state.carts.map((x, i) => <ListGroup.Item key={i}>
                <Row>
                  ...
                  <Col sm="auto">
                    <div style={{width: 75, height: 75, display: 'table-cell', verticalAlign: 'middle', textAlign: 'center'}}>
                      <Image style={{maxHeight: 75, maxWidth: 75}} src={x.book.img}/>
                    </div> {/* TODO: 有空把其他图片也改成这个样式 */}
                  </Col>
                  <Col>
